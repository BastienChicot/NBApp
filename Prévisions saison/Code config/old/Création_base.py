# -*- coding: utf-8 -*-
"""
Created on Mon Aug 23 11:48:24 2021
...
final_coach=pd.read_csv('coachs.csv', sep=";")
player_name = player_name.drop(["first_name","last_name","lettre"], axis=1)
df_propre = []
...
data_ML.to_csv("../Prévisions saison/base.csv", sep=";")